...
Scripts to run this analysis can be found in [Pseudomonas_sample_lvl_sim.ipynb](https://github.com/greenelab/simulate-expression-compendia/blob/master/Pseudomonas/Pseudomonas_sample_lvl_sim.ipynb)  
...
![Similarity_Pa_sample](https://github.com/greenelab/simulate-expression-compendia/blob/master/Pseudomonas/results/Pseudomonas_sample_lvl_sim_svcca_limma.png)

## Experiment-level simulation experiment 
Scripts to run this analysis can be found in [Pseudomonas_experiment_lvl_sim.ipynb](https://github.com/greenelab/simulate-expression-compendia/blob/master/Pseudomonas/Pseudomonas_experiment_lvl_sim.ipynb)  
...
![Similarity_Pa_experiment](https://github.com/greenelab/simulate-expression-compendia/blob/master/Pseudomonas/results/Pseudomonas_experiment_lvl_sim_svcca_limma.png)