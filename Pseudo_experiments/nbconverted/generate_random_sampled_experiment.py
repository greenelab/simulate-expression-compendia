...
# # Explore randomly-sampled experiments
# 
# This notebook examines experiments generated by the random sampling approach (sample level simulation).  We use this as a control for our pseudo experiments generated the experiment-preserving approach that is implemented in ```generate_E_GEOD_51409_template_experiment.ipynb```
